...
export function TrackingPage() {
  ...
  return (
    <div 
      className="relative w-full h-[150vh] bg-black overflow-hidden"
      ref={containerRef}
    >
      {/* Hero Text */}
      ...
      <div className="sticky top-0 left-0 w-full h-screen z-0 overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-10">
          <svg className="w-full h-full max-w-5xl" viewBox="0 0 800 600" fill="none" preserveAspectRatio="xMidYMid meet">
            ...
            <motion.path 
              ...
              fill="none" 
              style={{ pathLength }}
              className="drop-shadow-[0_0_15px_rgba(0,122,255,0.8)]"
            />
            {/* Start & End Points */}
        ...
        <div className="absolute inset-0 z-20 pointer-events-none flex items-center justify-center max-w-[1200px] mx-auto">
          ...
          <motion.div 
            style={{ y: yParallax1 }}
            className="absolute left-[5%] md:left-[20%] top-[30%] md:top-[40%] bg-white/5 backdrop-blur-[24px] border border-white/20 shadow-[inset_0_1px_1px_rgba(255,255,255,0.4),0_20px_40px_rgba(0,0,0,0.5)] rounded-[32px] p-6 w-[240px] md:w-[280px] pointer-events-auto"
          >
            <div className="flex items-center justify-between mb-6">
              <span className="text-white font-medium text-base md:text-lg">Cargo Health</span>
            ...
            <div className="relative flex items-center justify-center py-4">
              ...
              <svg className="w-28 h-28 md:w-32 md:h-32 transform -rotate-90">
                ...
                <motion.circle 
                  ...
                  className="drop-shadow-[0_0_10px_rgba(52,199,89,0.6)] stroke-round"
                  strokeLinecap="round"
                />
              </svg>
              <div className="absolute flex flex-col items-center">
                <span className="text-2xl md:text-3xl font-bold text-white">98%</span>
                <span className="text-[10px] md:text-xs text-zinc-400">Active</span>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div 
            style={{ y: yParallax2 }}
            className="absolute right-[5%] md:right-[20%] top-[65%] md:top-[60%] bg-black/60 backdrop-blur-[30px] border border-white/20 shadow-[inset_0_1px_1px_rgba(255,255,255,0.3),0_20px_40px_rgba(0,0,0,0.5)] rounded-[32px] p-5 md:p-6 w-[220px] md:w-[260px] pointer-events-auto"
          >
            <div className="flex items-center space-x-3 mb-2">
              ...
              <span className="text-[#FF3B30] font-semibold text-sm tracking-wide uppercase">Warning</span>
            </div>
            <h3 className="text-white text-xl font-medium mt-3 mb-1">Temp Anomaly</h3>
            <div className="flex items-baseline space-x-1">
              <span className="text-4xl font-bold text-white tracking-tight">18.5</span>
              <span className="text-zinc-400 text-lg">°C</span>
            </div>
            <div className="mt-4 pt-4 border-t border-white/10 flex items-center justify-between text-sm">
              <span className="text-zinc-400">Unit 04 - Reefer</span>
              <span className="text-white font-mono bg-white/10 px-2 py-1 rounded">Action Req</span>
            </div>
          </motion.div>
