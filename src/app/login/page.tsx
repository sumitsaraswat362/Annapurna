          ...
          <div className="space-y-5 relative z-10">
            ...
            <div>
              ...
              <input type="password" value={password} onChange={(e) => setPassword(e.target.value)}
                ...
                className="w-full bg-[var(--fill-secondary)] border border-[var(--separator)] rounded-[20px] px-6 py-4.5 text-[var(--text-primary)] placeholder:text-[var(--text-tertiary)] focus:outline-none focus:bg-[var(--bg-primary)] focus:ring-2 focus:ring-[#007AFF] focus:border-transparent transition-all shadow-sm text-[16px] font-bold tracking-widest"
              />
            </div>
