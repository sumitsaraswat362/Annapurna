    ...
    <main className="min-h-dvh flex flex-col items-center justify-center p-6 relative overflow-hidden bg-[var(--bg-primary)] aura-container">
      ...
      >
        ...
        >
          ...
          <button type="button" onClick={handleGoogleLogin} disabled={googleLoading} className="w-full mt-6 relative group outline-none flex items-center justify-center gap-3 py-4 rounded-[20px] bg-white text-black font-extrabold text-[16px] shadow-[0_4px_14px_0_rgba(0,0,0,0.1)] hover:shadow-[0_6px_20px_rgba(0,118,255,0.23)] hover:scale-[1.01] transition-all active:scale-[0.98] z-10 border border-white/20 disabled:opacity-60 disabled:cursor-not-allowed">
            {googleLoading ? (
