...
export const DEMO_BIDS: Bid[] = [
  {
    ...
    wholesalerLocation: { lat: 19.2437, lng: 73.1355 },
    distanceKm: 12,
    etaMinutes: 18,
    ...
    totalValue: 48000,
    createdAt: Date.now(),
    expiresAt: Date.now() + 4.5 * 60 * 1000, // 4.5 minutes
    status: "pending",
  },
  {
    id: "bid-002",
    cargoId: "cargo-001",
    wholesalerId: "ws-002",
    wholesalerName: "Fresh Foods Co.",
    wholesalerLocation: { lat: 19.2183, lng: 72.9781 },
    distanceKm: 35,
    etaMinutes: 42,
